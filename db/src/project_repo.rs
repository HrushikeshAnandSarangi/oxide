...
impl ProjectRepository {
    ...
    pub async fn find_by_id(
        &self,
        id: &uuid::Uuid,
    ) -> Result<Option<crate::models::ProjectRow>, sqlx::Error> {
        sqlx::query_as::<_, crate::models::ProjectRow>("SELECT * FROM projects WHERE id = $1")
            .bind(id)
            .fetch_optional(&self.pool)
            .await
    }
    ...
    pub async fn add_env_var(
        &self,
        env_var: &domain::project::ProjectEnvVar,
    ) -> Result<(), sqlx::Error> {
        sqlx::query(
            r#"
    ...
    pub async fn get_env_vars(
        &self,
        project_id: uuid::Uuid,
    ) -> Result<Vec<crate::models::ProjectEnvVarRow>, sqlx::Error> {
